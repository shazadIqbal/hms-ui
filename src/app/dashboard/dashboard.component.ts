...
totalamountcolumnchart=  {
  ...
  saveddate(){
    ...
    this.service.totalbydate(this.dashboard).subscribe((data) =>{ 
      ...
      this.messageservice.add({severity:'error', summary:'Status', detail:'something went wrong please refresh the page'});
    })
  
  

    this.service.total(this.dashboard).subscribe((responce) =>{ 
      console.log("totalamount", responce);
      
       this.totalamountcolumnchart.data = responce;
       this.totalamountcolumnchart.chart.subcaption="["+datefrom+" "+" "+"to"+" "+" " +datetill+"]";
       this.showspinloading=false;
  ...
  this.service.duestotal(this.dashboard).subscribe((data) =>{  
    ...
    this.duestotalcoloumnchart.chart.subcaption="["+datefrom+" "+" "+"to"+" "+" " +datetill+"]";
    this.showspinloading=false;
  ...
  this.service.duesbydate(this.dashboard).subscribe((data) =>{ 
    ...
    this.duesbydatetotal.chart.subcaption="["+datefrom+" "+" "+"to"+" "+" " +datetill+"]";
    this.showspinloading=false;
...
this.service.patientsbydate(this.dashboard).subscribe((data) =>{ 
  ...
  this.patientsbydatetotal.chart.subcaption="["+datefrom+" "+" "+"to"+" "+" " +datetill+"]";  
  this.showspinloading=false;
}, error=>{
  console.log(error);
  this.messageservice.add({severity:'error', summary:'Status', detail:'something went wrong please refresh the page'});
