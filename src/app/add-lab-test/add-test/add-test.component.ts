...
export class AddTestComponent implements OnInit {
  ...
  constructor(private labservice: LabtestServiceService,private messageService: MessageService, private route:Router) {
  ...
  submitlab() {
    ...
    this.labservice.postlabtest(this.test).subscribe((d) => {
      this.loader=false;
